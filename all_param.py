    ...
    for gj in range(0, 5*2):
        ...
        for gs in range(5*2):
            ...
            for cann in range(1):
                ...
                for akum in range(1, 2):

                    for vz_cent in range(1, 2):

                        for param1 in range(1, 2):

                            for param2 in range(1, 2):

                                for min_pol in range(1, 2):

                                    for max_pol in range(1, 2):
                                        id += 1
                                        finall_image = set_hough(canny, akum, vz_cent, param1, param2, min_pol, max_pol)
                                        cv.imshow(img_name + str(" ID:   ") + str(id), finall_image)
                                        k = cv.waitKey(0)
